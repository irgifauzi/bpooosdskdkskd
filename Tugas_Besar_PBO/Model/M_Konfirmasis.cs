...
{
    internal class M_Konfirmasis
    {
        string id_username, id_server, jumlah_diamond, bonus_diamond, harga, email, metode_pembayaran, status;

        public M_Konfirmasis()
        {
        }

        public M_Konfirmasis(string id_username, string id_server, string jumlah_diamond, string bonus_diamond, string harga, string email, string metode_pembayaran, string status)
        {
